...
sapply(list('calc_sfn_aggr_E_hourly.R','calc_sfn_aggr_env_hourly.R',
            'calc_sfn_aggr_env.R','calc_sfn_scale.R','swvl_aggregation.R',
            'calc_optim_swc.R','do_phydro_params.R', "rpmodel_subdaily.R",
            'data_processing_functions.R','calc_models.R',
            'stomatal_optimization_functions.R', 
            'pmodel_ecrit.R'), source, .GlobalEnv)

#### LOAD DATA LIST ####
path <- "DATA/PREPARED_DATA_LIST_HOURLY"
