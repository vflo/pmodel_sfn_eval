...
$$
(1-\frac{E}{E_\mathrm{crit}}) = 1 - \frac{ \int_{\psi_\mathrm{s}}^{\psi_\mathrm{s}-\Delta\psi} P(\psi) \,d\psi}{ \int_{\psi_\mathrm{s}}^{\infty} P(\psi) \,d\psi} 
$$
...
$$
F = g_\mathrm{s}  c_\mathrm{a} (1-\chi) ( 1 - \frac{ \int_{\psi_\mathrm{s}}^{\psi_\mathrm{s}-\Delta\psi} P(\psi) \,d\psi}{ \int_{\psi_\mathrm{s}}^{\infty} P(\psi) \,d\psi} ) - \alpha J_\mathrm{max} ( 1 - \frac{ \int_{\psi_\mathrm{s}}^{\psi_\mathrm{s}-\Delta\psi} P(\psi) \,d\psi}{ \int_{\psi_\mathrm{s}}^{\infty} P(\psi) \,d\psi} )
$$

Solved by $\chi$
$$
\frac{\partial F}{\partial \chi} = \frac{(\alpha \frac{\partial J_\mathrm{max}}{\partial A_{Jm}} \frac{\partial A_{Jm}}{\partial \chi} + g_s c_a)\,(\int_{\psi_\mathrm{s}}^{\psi_\mathrm{s}-\Delta\psi} P(\psi) \,d\psi - \int_{\psi_\mathrm{s}}^{\infty} P(\psi) \,d\psi)}{\int_{\psi_\mathrm{s}}^{\infty} P(\psi) \,d\psi} = 0
$$

Solved by $\Delta\psi$
$$
\frac{\partial F}{\partial \Delta\psi} = \frac{1}{\int_{\psi_\mathrm{s}}^{\infty} P(\psi) \,d\psi}\,((\int_{\psi_\mathrm{s}}^{\psi_\mathrm{s}-\Delta\psi} P(\psi) \,d\psi - \int_{\psi_\mathrm{s}}^{\infty} P(\psi) \,d\psi)\,(\alpha \frac{\partial J_\mathrm{max}}{\partial A_{Jm}} \frac{\partial A_{Jm}}{\partial \Delta\psi}+c_a (1-\chi)\frac{\partial g_s}{\partial \Delta\psi} ))+\alpha\, J_\mathrm{max}\,\frac{1}{2} ^{(\frac{\psi_\mathrm{s}-\Delta\psi}{\psi_{50}})^b}+g_s\, c_a\, (1-\chi)\frac{1}{2} ^{(\frac{\psi_\mathrm{s}-\Delta\psi}{\psi_{50}})^b}= 0
$$
