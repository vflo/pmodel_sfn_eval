...
$$
F_{ProfitMax} = A_j - A_{max} (\frac{k_\mathrm{\psi_s}-k_\mathrm{\psi_l}}{k_\mathrm{\psi_s}-k_\mathrm{\psi_{crit}}})
$$
...
calc_phydro_sperry_test <- function(tc, ppfd, vpd, co2, elv, LAI, fapar, kphio, psi_soil, par_plant, rdark, par_cost = NULL){
  ...
  # lj_dps_lim = optimise_stomata_phydro_test(fn_profit_phydro_sperry_test, 
  #                                    psi_soil = 0, 
