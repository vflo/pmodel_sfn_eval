...
fn_profit_gs <- function(par, psi_soil, par_cost, e_crit, p_crit, par_photosynth, 
  ...
  if(stomatal_model == "phydro_cgain2"){
    P   = (1/2)^((psi_leaf/par_plant$psi50)^par_plant$b)
    out = a - par_cost$alpha*jmax - par_cost$gamma/P
  }
