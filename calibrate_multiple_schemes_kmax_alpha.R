...
get_parameters <- function(x){
  ...
  readr::write_csv(df,file=paste0("DATA/parameter_kmax_alpha/",stomatal_model_now,"_",species,"_",dpsi_calib_now,"_",inst,".csv"))
...
save(res,file = "DATA/K_sperry_meta-analysis_kmax_alpha.RData")

load(file = "DATA/K_sperry_meta-analysis_kmax_alpha.RData")
